 ...
 */
public class RoutersJSON extends Activity {
    ...
    public static RoutersJSON parser = null;

    public static RoutersJSON shared(){
        if (parser  == null){
            parser  = new RoutersJSON();
        }
        return parser ;
    }
    ...
    public void getJSON() {
        ...
        neutronURL = neutronURL+"/v2.0/routers";
