...
public class NetworksFragment extends Fragment {
     ...
     * number.
     */
    public static NetworksFragment newInstance(int sectionNumber) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Serializable parsedList = extras.getSerializable("NetworksParsed");
        ...
        recyclerView = (RecyclerView)rootView.findViewById(R.id.networksRV);
        return rootView;
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        NetworksAdapter networksAdapter = new NetworksAdapter(getActivity(),jsonList);
            ...
            alert.setMessage("Authentication Token expired! Please login again.")
                    .setNeutralButton("Connect", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            getActivity().finish();
                            getFragmentManager().beginTransaction().remove(NetworksFragment.this).commit();
                        }
                    });
