 ...
 */
public class SecurityJSON extends Activity {
    ...
    public static SecurityJSON parser = null;

    public static SecurityJSON shared(){
        if (parser  == null){
            parser  = new SecurityJSON();
        }
        return parser ;
    }
    ...
    public void getJSON() {
        ...
        neutronURL = neutronURL+"/v2.0/security-groups";
