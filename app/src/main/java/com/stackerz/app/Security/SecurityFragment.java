...
public class SecurityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Serializable parsedList = extras.getSerializable("SecurityParsed");
        ...
        recyclerView = (RecyclerView)rootView.findViewById(R.id.securityRV);
        return rootView;
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        SecurityAdapter securityAdapter = new SecurityAdapter(getActivity(),jsonList);
            ...
            alert.setMessage("Authentication Token expired! Please login again.")
                    .setNeutralButton("Connect", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            getActivity().finish();
                            getFragmentManager().beginTransaction().remove(SecurityFragment.this).commit();
                        }
                    });
