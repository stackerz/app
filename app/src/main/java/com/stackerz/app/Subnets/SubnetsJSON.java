 ...
 */
public class SubnetsJSON extends Activity {
    ...
    public static SubnetsJSON parser = null;

    public static SubnetsJSON shared(){
        if (parser  == null){
            parser  = new SubnetsJSON();
        }
        return parser ;
    }
    ...
    public void getJSON() {
        ...
        neutronURL = neutronURL+"/v2.0/subnets";
