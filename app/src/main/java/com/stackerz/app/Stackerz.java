...
public class Stackerz extends Activity
    ...
    public Bundle subnetsBundle(){
        ...
        if (subnets != null) {
            ...
            subnetsCached = shPref.getString("Subnets",subnetsCached);
    ...
    public Bundle routersBundle(){
        ...
        if (routers != null) {
            ...
            routersCached = shPref.getString("Routers",routersCached);
    ...
    public Bundle securityBundle(){
        ...
        if (security != null) {
            ...
            securityCached = shPref.getString("Security",securityCached);
